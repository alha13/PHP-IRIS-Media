  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body class="bg-light">
        <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #ee5017;">
            <div class="container">
                <a class="navbar-brand text-uppercase" href="index.php" target="ext"><b>IRIS</b></a>
                <a class="navbar-toggler" data-toggle="collapse" data-target=".navbar-collapse"> <span class="navbar-toggler-icon"></span> </a>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item">
                            <a href="indeex.php?page=art" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Articles</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="indeex.php?page=vid" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Videos</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="indeex.php?page=aud" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Audios</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="indeex.php?page=alb" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Albums</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="indeex.php?page=ann" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Annonces</b></a>
                        </li>
