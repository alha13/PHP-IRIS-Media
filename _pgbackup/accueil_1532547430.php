...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container bg-white">
            <div class="no-gutters row" style="margin-right: -197px;">
                <!-- left side column -->
                <!--/end left column-->
                <!--mid column-->
                <div class="col-lg-3">
                    <div class="card rounded-0 border-right-0 border-left-0 sticky-top" id="midCol">
                        <div class="card-body rounded-0" style="margin-top: 26px;">
                ...
                <div class="col-lg-7" id="content">
                    <div class="card rounded-0 border-right-0 border-left-0">
                        <div class="card-body rounded-0" style="margin-top: 29px;">
                            <div class="row">
                                <div class="col-lg-8">
