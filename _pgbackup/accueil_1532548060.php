            ...
            <div class="no-gutters row">
                ...
                <div class="col-lg-7" id="content">
                    <div class="card rounded-0 border-right-0 border-left-0">
                        ...
                        <div class="card-body rounded-0" style="width: 900px; margin-left: 15px;">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="container col-xl-11" style="height: 50px; background-color: rgba(201, 199, 198, 0.8); margin-left: -18px; margin-right: -12px; padding-right: -28px; right: -12px; text-align: center;">
                                        <h4><b id="TITREacc" style="color: rgba(252, 111, 32, 0.98);">ARTICLES</b></h4>
                                    </div>
                                    <div class="row" style="margin-right: 0px;">
</div>
                                    <div class="row">
                                        <div class="card card-body col-xl-5" style="top: 18px; margin-bottom: 21px; width: 300px; margin-right: 57px;"> 
                                        ...
                                        <div class="card card-body col-xl-5" style="top: 18px; margin-bottom: 21px; width: 300px; margin-right: 6px;"> 
                                            <h2 class="text-center"><img src="img/ID%2520tete.jpg" class="img-fluid" width="300px"></h2>
                                            <h1 class="text-center">The "flat" look was a big trend this year</h1>
                                            <button class="btn btn-secondary" style="text-align: center;">Plus...</button>
                                        </div>
