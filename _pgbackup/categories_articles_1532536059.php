            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item">
                            <a href="#" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Articles</b><b style="color: #ffffff; margin-right: 14px;">Videos</b><b style="color: #ffffff; margin-right: 14px;">Albumes</b><b style="color: #ffffff; margin-right: 14px;">AUdios</b><b style="color: #ffffff; margin-right: 14px;">AUdios</b><b style="color: #ffffff;">Annonces</b></a>
                        </li>
                        <li class="nav-item">
</li>
                    </ul>
                        ...
                        <div class="card-body rounded-10">
                            ...
                            <div class="row">
                                ...
                                <div class="thumbnail" style="width: 374px; margin-right: 25px; margin-left: 76px;">
                                    <img src="http://placehold.it/320x200" alt="ALT NAME" class="img-fluid">
                                    <div class="caption">
                                        <h3>Header Name</h3>
                                ...
                                <div class="thumbnail" style="width: 374px; margin-right: 43px; margin-left: 29px;">
                                    <img src="http://placehold.it/320x200" alt="ALT NAME" class="img-responsive">
                                    <div class="caption">
                                        <h3>Header Name</h3>
                                        <p>DescriptionPorttitor vitae ultrices quis, dapibus id dolor. Morbi venenatis lacinia rhoncus. Vestibulum tincidunt ullamcorper eros eget luctus. Nulla eget porttitor libero... <a href="http://demos.themes.guide/bodeo/demo-v1.1.3/blog-detail.html" style="background-color: rgb(255, 255, 255);">Read More</a>Porttitor vitae ultrices quis, dapibus id dolor. Morbi venenatis lacinia rhoncus. Vestibulum tincidunt ullamcorper eros eget luctus. Nulla eget porttitor libero... <a href="http://demos.themes.guide/bodeo/demo-v1.1.3/blog-detail.html" style="background-color: rgb(255, 255, 255);">Read More</a></p>
                                ...
                                <div class="thumbnail" style="width: 374px; margin-right: 43px; margin-left: 76px;">
                                    <img src="http://placehold.it/320x200" alt="ALT NAME" class="img-responsive">
                                    <div class="caption">
                                        <h3>Header Name</h3>
                                        <p>DescriptionPorttitor vitae ultrices quis, dapibus id dolor. Morbi venenatis lacinia rhoncus. Vestibulum tincidunt ullamcorper eros eget luctus. Nulla eget porttitor libero... <a href="http://demos.themes.guide/bodeo/demo-v1.1.3/blog-detail.html" style="background-color: rgb(255, 255, 255);">Read More</a>Porttitor vitae ultrices quis, dapibus id dolor. Morbi venenatis lacinia rhoncus. Vestibulum tincidunt ullamcorper eros eget luctus. Nulla eget porttitor libero... <a href="http://demos.themes.guide/bodeo/demo-v1.1.3/blog-detail.html" style="background-color: rgb(255, 255, 255);">Read More</a></p>
