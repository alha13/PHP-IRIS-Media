            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item">
                            <a href="#sssssssssssssssssssss" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Articles</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="#sssssssssssssssssssss" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Videos</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="#sssssssssssssssssssss" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Audios</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="#sssssssssssssssssssss" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Albums</b></a>
                        </li>
                        <li class="nav-item">
                            <a href="#sssssssssssssssssssss" class="nav-link" style="background-color: rgba(237, 63, 0, 0);"><b style="color: #ffffff; margin-right: 14px;">Annonces</b></a>
                        </li>
...
try {//admga adlic adtenv adplb 
    switch ($_GET['page']) {
      ...
      echo $e->errorMessage();
                    ...
                    <ul class="ml-auto navbar-nav">
                        <li class="dropdown nav-item" style="right: -456px;">
