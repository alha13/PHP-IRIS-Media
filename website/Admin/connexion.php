        ...
        <div class="card card-container">
           ...
           <p id="profile-name" class="profile-name-card"></p>
            <form class="form-signin">
                ...
                <input type="password" id="inputPassword" name ="mpasse" class="form-control" placeholder="Password" required>
                <div id="remember" class="checkbox">
                    <label>
                        <input type="checkbox" value="remember-me">Rester connecter
                    </label>
                </div>
                <button class="btn btn-lg btn-primary btn-block btn-signin" name="connexion" type="submit">Se connecter</button>
            </form><!-- /form -->
