                ...
                <div class="col-md-8 ">
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label for="exampleInputName2" style="color: red">Titre: </label>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="exampleInputEmail2">Description</label>
                       <textarea  type="text" style="width: 750px; height=200px" name="text" 
                         id="exampleInputEmail2"  class="form-control input-sm" placeholder="Description">
                        </textarea>
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="source"  id="exampleInputEmail2">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail2">Texte</label>
                        <textarea  type="text" style="width:750px ; height:300px " name="description" required id="email" class="form-control input-sm" placeholder="Description">
                        </textarea>
                    </div>
                     <div class="form-group">
                  ...
                  <ul class="list-inline banner-social-buttons">
                    <li><button type="submit" name="modifier" class="btn btn-default">Modifier</button></li>
                     <li><button type="submit" class="btn btn-default"><a href="" style="color:black">Supprimer</a></button></li>
                    <li><button type="submit" name="publier" class="btn btn-default">Publier</button></li>
                    <li><button type="submit" name="retirer" class="btn btn-default">Retirer</button></li>
                  </ul>
                </div>
