...
$id = $_GET["id"];
//echo $id .' " " ';
$sql2 = "SELECT * FROM articles t1 JOIN categorie t2 ON t1.id_categorie = t2.id_categorie where t1.id_articles = $id";
        ...
        <div class="contact-section">
            <div class="container">
              <div class="row">
                  ...
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label for="exampleInputName2" style="color: #FC6F20">TITRE: </label>
                       ...
                       <label for="exampleInputName2" ><h3><?php echo $resultat['titre_articles'] ?></h3></label>
                    </div>
                   <div class="form-group">
                       <tr>
                        <label for="exampleInputName2" style="color: #FC6F20">CATEGORIE: </label>
                         </br>
                     ...
                     <div class="form-group">
                      <label for="exampleInputEmail2" style="color: #FC6F20">DESCRIPTION : </label>
                       ...
                       <label  for="exampleInputEmail2"><h3><?php echo $resultat['description_articles'] ?></h3> </label>
                    </div>
                      </br>
                        </br>
                     <div class="form-group">
                      <label for="exampleInputEmail2" style="color: #FC6F20">DATE :</label>
                       ...
                       <label for="exampleInputEmail2"><h3><?php echo $resultat['date_articles'] ?></h3> </label>   
                    </div>
                      </br>
                        </br>
                     <div class="form-group">
                      ...
                      <label for="exampleInputEmail2"><h3><?php echo $resultat['source_articles'] ?></h3> </label>
                     ...
                     <div class="form-group">
                      <label for="exampleInputEmail2" style="color: #FC6F20">TEXTE : </label>
                       ...
                       <label for="exampleInputEmail2"><h3><?php echo $resultat['texte_articles'] ?></h3> </label>
               ...
               <?php echo "<li><button type='submit' name='modifier' class='btn btn-default'  ><a href='mod_art.php?id={$resultat['id_articles']}'>Modifier</a></button></li>" ?>
                <?php echo "<li><button type='submit' class='btn btn-default'><a href='sup_art.php?id={$resultat['id_articles']}' style='color:black'>Supprimer</a></button></li>" ?>

                    <li> <?php echo "<li><button type='submit' class='btn btn-default'><a href='publ_art.php?id={$resultat['id_articles']}' style='color:black'>Publier</a></button></li>" ?>

                    <li><li> <?php echo "<li><button type='submit' class='btn btn-default'><a href='retir_art.php?id={$resultat['id_articles']}' style='color:black'>Retirer</a></button></li>" ?></li>
                  </ul>
                </div>
