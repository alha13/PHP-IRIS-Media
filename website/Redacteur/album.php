...
// $categorie = htmlspecialchars(trim($_POST["categorie"]));
 ...
 $sql = "INSERT INTO albums (titre_albums,description_albums,photo_albums,date_albums,source_albums,id_categorie) VALUES(?,?,?,?,?,?)";
    $query = $bd->prepare($sql);
    $query->execute(array(
            $titre, $description, $path, $date, $source, $idcategorie
        ));
      }
?>
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="titre" id="exampleInputName2" required>
                    </div>
                    <div class="form-group">
      <tr>
...
<div class="container">
  <div class="row">
        ...
        <div class="col-md-12">
        <h1><center>Table Des Albums</center></h1>
        ...
        <?php
$sql2 = "SELECT * FROM categorie t1 JOIN albums t2 ON t1.id_categorie = t2.id_categorie ORDER BY id_album DESC LIMIT 50";
    ...
    while ($row = $query2->fetch()) 
      {
        ...
        echo "<td class='cell0'><span id='14' >" . $row['titre_albums'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['description_albums'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . '<img style width="70" height="70" src = "../../'. $row['photo_albums']. '">  </span></td>';
         echo "<td class='cell0'><span id='14' >" . $row['date_albums'] . " </span></td>";
        echo "<td class='cell0' style='content-center'><span id='14' >" . $row['source_albums'] . " </span></td>";
        ...
        echo "<td class='cell0'><span id='14' >" . $row['libele_categorie'] . " </span></td>";
          echo " <td> <a href='afficher_al.php?id={$row['id_album']}'</a>Afficher</td>";
    }
            // <td class="cell6"><span id="wb_uid15"> </span></td>
    ?>
