...
if (!empty($_POST["executer"]) ) {
 ...
 $sql = "INSERT INTO audios (titre_audios,link_audios,date_audios,description_audios,image_audios,source_audios,id_categorie) VALUES(?,?,?,?,?,?,?)";
    $query = $bd->prepare($sql);
    $query->execute(array(
             $titre ,  $lien,$date , $description, $path , $source ,  $idcategorie
        ));
      }
     ?>
...
<section id="contact" class="content-section text-center">
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="titre" id="exampleInputName2">
                    </div>
                     <div class="form-group">
                        <tr>
    ...
    $query = $bd->query("SELECT * FROM categorie")->fetchAll(); ?>
            ...
            ?>
                      ...
                      <input type="text" required class="form-control" name="lien" id="exampleInputEmail2">
                    </div>
                     <div class="form-group">
...
<div class="container">
  <div class="row">
        ...
        <div class="col-md-12">
        <h1><center>Table Des Audios</center></h1>
...
<?php
$sql2 = "SELECT * FROM categorie t1 JOIN audios t2 ON t1.id_categorie = t2.id_categorie ORDER BY id_audios DESC LIMIT 50";
    ...
    while ($row = $query2->fetch()) 
      {
        ...
        echo "<td class='cell0'><span id='14'>" . $row['titre_audios'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['link_audios'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['date_audios'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['description_audios'] . " </span></td>";
         echo "<td class='cell0'><span id='14'>" . '<img style width="70" height="70" src = "../../'. $row['image_audios']. '">  </span></td>';
         echo "<td class='cell0'><span id='14' >" . $row['source_audios'] . " </span></td>";
          echo "<td class='cell0'><span id='14' >" . $row['libele_categorie'] . " </span></td>";
          echo " <td> <a href='afficher_au.php?id={$row['id_audios']}'</a>Afficher</td>";
    }
