...
$sql = "UPDATE albums SET titre_albums=?  ,description_albums=? ,photo_albums=?, date_albums = ? ,source_albums =?, id_categorie = ? WHERE id_album = '$id' ";
              ...
              <div class="row">
                <div class="col-md-8 ">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="tire" id="exampleInputName2" value="<?php echo $resultat['titre_albums'] ?>">
                    </div>
                    <div class="form-group">
    ...
    $query = $bd->query("SELECT * FROM categorie")->fetchAll(); ?>
            ...
            ?>
                     ...
                     <div class="form-group">
                      ...
                      <input type="Date" name="date" required id="exampleInputEmail2" class="form-control input-sm" placeholder="Date d'ajout" value="<?php echo $resultat['date_albums'] ?>">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail2">Source</label>
                      <input type="text" class="form-control" name="source" id="exampleInputEmail2" value="<?php echo $resultat['source_albums'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail2">Description</label>
                        <textarea  type="text" style="width:750px ; height:200px " name="description" required id="email" class="form-control input-sm" placeholder="Description"><?php echo $resultat['description_albums'] ?>
                        </textarea>
                    </div>
