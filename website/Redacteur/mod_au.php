...
$sql = "UPDATE audios SET titre_audios=?  ,link_audios=?, date_audios=? ,description_audios=?, image_audios = ? ,source_audios =?,  id_categorie = ? WHERE id_audios = '$id' ";
...
<section id="contact" class="content-section text-center">
                ...
                <div class="col-md-8 ">
                  <form  method="post" action="" enctype="multipart/form-data" >
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="titre" id="exampleInputName2" value="<?php echo $resultat['titre_audios'] ?>">
                    </div>
                     <div class="form-group">
    ...
    $query = $bd->query("SELECT * FROM categorie")->fetchAll(); ?>
            ...
            ?>
                      ...
                      <div class="form-group">
                      <label for="exampleInputEmail2">Lien</label>
                      <input type="text" class="form-control"  value="<?php echo $resultat['link_audios'] ?>" name="lien" id="exampleInputEmail2">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail2">Date</label>
                      <input type="Date" name="date" required id="exampleInputEmail2" class="form-control input-sm" placeholder="Date d'ajout" value="<?php echo $resultat['date_audios'] ?>">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail2">Source</label>
                      <input type="text" class="form-control" name="source" id="exampleInputEmail2" value="<?php echo $resultat['source_audios'] ?>">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail2">Description</label>
                        <textarea  type="text" style="width:750px ; height:200px " name="description" required id="email" class="form-control input-sm" placeholder="Description"><?php echo $resultat['description_audios'] ?>
                        </textarea>
                    </div>
                  ...
                  <ul class="list-inline banner-social-buttons">
                    <li><input type="submit" name="modifier" class="btn btn-default" value="Modifier"  ></li>
