...
$sql = "UPDATE videos SET titre_videos=?  ,description_videos=? ,link_videos=?, date_videos = ? ,image_videos =?, sources_videos = ?, id_categorie = ? WHERE id_videos = '$id' ";
...
<section id="contact" class="content-section text-center">
                ...
                <div class="col-md-8 ">
                  <form  method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input  value="<?php echo $resultat['titre_videos'] ?>" type="text" class="form-control" name="titre" id="exampleInputName2">
                    </div>
                   <div class="form-group">
    ...
    $query = $bd->query("SELECT * FROM categorie")->fetchAll(); ?>
            ...
            ?>
                      ...
                      <input type="text" class="form-control" name="lien" id="exampleInputEmail2" value="<?php echo $resultat['link_videos'] ?>">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail2">Date</label>
                      <input type="Date" name="date" required id="exampleInputEmail2" class="form-control input-sm" placeholder="Date d'ajout" value="<?php echo $resultat['date_videos'] ?>">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail2">Source</label>
                      <input type="text" class="form-control" name="source" id="exampleInputEmail2" value="<?php echo $resultat['sources_videos'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail2">Description</label>
                        <textarea  type="text" style="width:750px ; height:200px " name="description" required id="email" class="form-control input-sm" placeholder="Description"><?php echo $resultat['description_videos'] ?>
                        </textarea>
                    </div> 
