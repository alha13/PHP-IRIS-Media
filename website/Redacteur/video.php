...
if (!empty($_POST["executer"]) ) {
 ...
 $sql = "INSERT INTO videos (titre_videos,description_videos,link_videos,date_videos,image_videos,sources_videos,id_categorie) VALUES(?,?,?,?,?,?,?)";
    $query = $bd->prepare($sql);
    $query->execute(array(
             $titre , $description,  $lien, $date , $path ,  $source,  $idcategorie
        ));
      }
     ?><!DOCTYPE html>
<html>
...
<div class="container">
  <div class="row">
        ...
        <div class="col-md-12">
        <h1><center>Table Des Videos</center></h1>
...
<?php
$sql2 = "SELECT * FROM categorie t1 JOIN videos t2 ON t1.id_categorie = t2.id_categorie ORDER BY id_videos DESC LIMIT 50";
    ...
    while ($row = $query2->fetch()) 
      {
        ...
        echo "<td class='cell0'><span id='14'>" . $row['titre_videos'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['libele_categorie'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['link_videos'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['date_videos'] . " </span></td>";
        echo "<td class='cell0'><span id='14' >" . $row['sources_videos'] . " </span></td>";
         echo "<td class='cell0'><span id='14' >" .$row['description_videos'] . " </span></td>";
         echo "<td class='cell0'><span id='14'>" . '<img style width="70" height="70" src = "../../'. $row['image_videos']. '">  </span></td>';
          echo " <td> <a href='afficher_vid.php?id={$row['id_videos']}'</a>Afficher</td>";
